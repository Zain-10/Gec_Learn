    ...
    <div>
      <div className={styles.main_container}>
        <div className={styles.container}>
          ...
          <div className='flex'>
            <a href="https://drive.google.com/drive/folders/1IzNm8RcGVR-5oFiuo7K3yF4LrWvvWrQj" target='_blank'>
              <div className='ml-14 mr-6'>
                <img src="/assets/note.png" width="50" height="50" className=""></img>
                <div className='mt-1 font-bold'>Notes</div>
              </div>
            </a>
            <a href="https://drive.google.com/drive/folders/1DYByzXTrCpzKxCfnG1QJoF4cFHXtiU6y" target='_blank'>
              <div className='mr-5'>
